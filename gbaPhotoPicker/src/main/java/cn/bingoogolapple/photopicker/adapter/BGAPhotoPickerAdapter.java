...
public class BGAPhotoPickerAdapter extends BGARecyclerViewAdapter<String> {
    ...
    protected void fillData(BGAViewHolderHelper helper, int position, String model) {
        if (mTakePhotoEnabled && position == 0) {
            ...
            BGAImage.displayImageAsBitmap(mActivity, helper.getImageView(R.id.iv_item_photo_picker_photo), model, R.mipmap.bga_pp_ic_holder_dark, R.mipmap.bga_pp_ic_holder_dark, mImageWidth, mImageHeight, null);
